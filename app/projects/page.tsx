    ...
    <section className="bg-white antialiased dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6 lg:py-24">
        <div className="max-w-2xl space-y-6">
          <div>
            <p className="text-lg font-medium leading-none text-primary-600 dark:text-primary-500">Trusted Worldwide</p>
        ...
        <div id="animation-carousel" data-carousel="slide" className="mt-8 sm:mt-12 lg:mt-16">
              ...
              <div className="grid grid-cols-1 gap-20 sm:grid-cols-2 xl:grid-cols-3">
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Official website</h3>
                    <a
                      href="#"
                      title=""
                  ...
                  <div className="flex items-center gap-2.5">
                    <div className="rounded-lg p-1 hover:bg-gray-50 dark:hover:bg-gray-800">
                      <img
                ...
                <div className="space-y-4">
                  ...
                  />
                  <div className="space-y-1">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Management system</h3>
                    <a
                      href="#"
                      title=""
                      className="inline-flex items-center text-lg font-medium text-primary-600 hover:underline dark:text-primary-500"
                ...
                <div className="space-y-4">
                  ...
                  />
                  <div className="space-y-1">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Logo design</h3>
                    <a
                      href="#"
                      title=""
                      className="inline-flex items-center text-lg font-medium text-primary-600 hover:underline dark:text-primary-500"
