...
export default function Page({ params }: Params): JSX.Element {
  ...
  return (
    <>
      ...
      <div className="mx-auto min-h-screen px-4 py-8 sm:px-6 sm:py-16 lg:py-24 lg:flex lg:max-w-6xl lg:gap-8">
...
export async function generateMetadata({ params }: Params, parent: ResolvingMetadata): Promise<Metadata> {
  ...
  return {
    ...
    twitter: {
      card: "summary_large_image", title, description, images: ["/img/logo.png"],
    },
  }
}
